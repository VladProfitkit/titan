				...
				<ul class="tabs_slider slides">
					...
					<?foreach($arResult['ITEMS'] as $key => $arItem){
						...
						<li class="catalog_item visible" id="<?=$arItem["strMainID"];?>">
										...
										<?}elseif ( $arItem["PRICES"] ){?>
											...
											<div class="price_matrix_wrapper ">
															<div class="price" data-currency="RUB" data-value="0">
																										<?=$arItem["PRICES"]['Розница']['PRINT_DISCOUNT_VALUE_VAT']?>										</div>
																													</div>
							...
							<a class="btn btn-default transition_bg basket read_more" rel="nofollow" href="<?=$arItem['DETAIL_PAGE_URL']?>" data-item="<?=$arItem['ID']?>">Подробнее</a>						</div>
								</div>
							</div>
